...
source: Google Search Central Core Web Vitals; web.dev Web Vitals
source_url: https://developers.google.com/search/docs/appearance/core-web-vitals; https://web.dev/articles/vitals
...
Google describes Core Web Vitals as part of page experience. They can support search performance, but Google also emphasizes that helpful, reliable content remains more important than page experience signals alone.

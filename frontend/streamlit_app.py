...
def get_plot_layout():
    ...
    if paper_mode:
        return dict(
            ...
            xaxis=dict(gridcolor="#dddddd", linecolor="#aaaaaa", tickfont=dict(color="#333333")),
            yaxis=dict(gridcolor="#dddddd", linecolor="#aaaaaa", tickfont=dict(color="#333333")),
        )
    return dict(
...
def get_colors():
    """Vivid for dark mode, muted for paper mode."""
    paper_mode = st.session_state.get("paper_mode", False)
    if paper_mode:
        return {"accent": "#1a7abf", "purple": "#7b2fa8", "green": "#1a8a5a",
                "gold": "#b8860b", "red": "#c0392b", "muted": "#555555"}
    return {"accent": "#00d4ff", "purple": "#a855f7", "green": "#00e5a0",
            "gold": "#f0c040", "red": "#ff4d6d", "muted": "#6b7fa3"}
